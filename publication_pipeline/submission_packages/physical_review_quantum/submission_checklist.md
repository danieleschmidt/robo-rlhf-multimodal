# Physical Review Quantum Submission Checklist

## Manuscript Requirements
- [x] Manuscript format: LaTeX
- [x] Word/page limit compliance: Within 8000 limit
- [x] Figure limit compliance: Within 8 limit
- [x] Reference limit compliance: Within 75 limit
- [x] Supplementary materials: Optional
